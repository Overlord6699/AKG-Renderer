...
namespace CGA_1
{
    public partial class Form1 : Form
    {
        ...
        private void trackBar1_Scroll(object sender, EventArgs e)
        {
            ...
            RedrawPicture(sender, e);
        }

        private void RedrawPicture(object sender, EventArgs e)
        {
                ...
                try
                {
                    ...
                    if (File.Exists(selectedFilePath))
                    {
                        ...
                        using (StreamReader reader = new StreamReader(selectedFilePath))
                        {
                            ...
                            parser.OnObjectParsed += RedrawPicture;

                            parser.ParseObjFile(ref _model, in selectedFilePath);
